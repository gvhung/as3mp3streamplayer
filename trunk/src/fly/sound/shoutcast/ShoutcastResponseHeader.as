package fly.sound.shoutcast
{
	import code.google.as3httpclient.HTTP_SEPARATOR;
	
	import flash.net.URLRequestHeader;
	
	public class ShoutcastResponseHeader
	{
		...
		/**
		 * @param completeHeader This is the complete Shoutcast response header.
		 */
		public function ShoutcastResponseHeader(completeHeader:String)
		{
			_headers = new Array();
			_headerObject = new Object();
			
			_parseHeader(completeHeader);
		}
		
		private function _parseHeader(completeHeader:String):void
		{
